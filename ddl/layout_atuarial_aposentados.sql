CREATE TABLE layout_atuarial_aposentados (
    id_layout_atuarial_aposentados BIGINT AUTO_INCREMENT PRIMARY KEY,

    /* =========================
       CHAVE NATURAL
       ========================= */
    ano_mes_competencia CHAR(6) NOT NULL COMMENT 'Competência no formato YYYYMM',
    matricula           VARCHAR(50) NOT NULL COMMENT 'RF + Vínculo do aposentado',
    situacao            VARCHAR(30) NOT NULL COMMENT 'Situação (APOSENTADO)',
    ...
    /* =========================
       DADOS DO APOSENTADO (RAW)
       ========================= */
    payload_json         JSON NOT NULL COMMENT 'Conteúdo bruto conforme dicionário APOSENTADOS',
    ...
    /* =========================
       CONSTRAINTS
       ========================= */
    CONSTRAINT uk_layout_atuarial_aposentados
        UNIQUE (
            ano_mes_competencia,
            matricula,
            situacao
...
COMMENT='RAW atuarial - Aposentados (1 linha por vínculo por competência)';
``