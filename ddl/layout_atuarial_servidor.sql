CREATE TABLE layout_atuarial_servidor (
    id_layout_atuarial_servidor BIGINT AUTO_INCREMENT PRIMARY KEY,

    /* =========================
       CHAVE NATURAL
       ========================= */
    ano_mes_competencia CHAR(6) NOT NULL COMMENT 'Competência no formato YYYYMM',
    matricula           VARCHAR(50) NOT NULL COMMENT 'RF + Vínculo',
    situacao            VARCHAR(30) NOT NULL COMMENT 'Situação do servidor (ex: SERVIDOR)',
    ...
    /* =========================
       DADOS DO SERVIDOR (RAW)
       ========================= */
    payload_json         JSON NOT NULL COMMENT 'Conteúdo bruto conforme dicionário SERVIDORES',
    ...
    /* =========================
       CONSTRAINTS
       ========================= */
    CONSTRAINT uk_layout_atuarial_servidor
        UNIQUE (
            ano_mes_competencia,
            matricula,
            situacao
...
COMMENT='RAW atuarial - Servidores (1 linha por vínculo por competência)';